...
## content/data/json/player_config.json by scripts/build_config.py (validated against
## content/data/schema/player_config.schema.json) and emitted to
## content/data/generated/player_config.tres. Never hand-edit the generated .tres or
...
## movement params (passed by PlayerController to PlayerMovementSystem), and the
...
# Movement params — pure inputs to PlayerMovementSystem. Godot's
