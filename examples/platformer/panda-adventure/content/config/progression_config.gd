...
## authoritative content/data/json/progression_config.json by scripts/build_config.py
## and emitted to content/data/generated/progression_config.tres. Never hand-edit the
