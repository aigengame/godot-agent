...
## authoritative content/data/json/scale_spec.json by scripts/build_config.py and
## emitted to content/data/generated/scale_spec.tres. Never hand-edit the generated
