...
## content/data/json/combat_config.json by scripts/build_config.py (validated against
## content/data/schema/combat_config.schema.json) and emitted to
## content/data/generated/combat_config.tres. Never hand-edit the generated .tres or
