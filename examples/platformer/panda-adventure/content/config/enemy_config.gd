...
extends "res://systems/stats_config.gd"
...
##
## This Resource is a DERIVED artifact: one content/data/generated/enemy_<kind>.tres per
## kind in the authoritative content/data/json/enemies_config.json, regenerated by
