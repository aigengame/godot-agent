...
## content/data/json/combat_config.json (its player_stats / enemy_stats blocks)
## by scripts/build_config.py and emitted to content/data/generated/stats_player.tres
## and stats_enemy.tres. Never hand-edit the generated .tres or hardcode these
