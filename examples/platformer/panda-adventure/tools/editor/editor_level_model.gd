...
const AUTHORITY_PATHS := {
	AUTHORITY_LEVEL: "res://content/data/json/level_config.json",
	AUTHORITY_ENEMIES: "res://content/data/json/enemies_config.json",
	AUTHORITY_PLAYER: "res://content/data/json/player_config.json",
	AUTHORITY_COMBAT: "res://content/data/json/combat_config.json",
	AUTHORITY_GRAVITY: "res://content/data/json/gravity_config.json",
	AUTHORITY_ITEMS: "res://content/data/json/items_config.json",
	AUTHORITY_HUD: "res://content/data/json/hud_config.json",
	AUTHORITY_PROGRESSION: "res://content/data/json/progression_config.json",
	AUTHORITY_SCALE: "res://content/data/json/scale_spec.json",
}
...
## Load every registered JSON authority from `res://content/data/json`. Returns false
...
## Read a JSON-Schema document (res://content/data/schema/…) for the forms to derive
