...
## [0.1.4](https://github.com/aigengame/godot-agent/compare/v0.1.3...v0.1.4) (2026-06-12)
...
* **gda:** add gda info headless tracer bullet ([6e00c8a](https://github.com/aigengame/godot-agent/commit/6e00c8a822cbf582b849089de2d06f74fb67f40b)), closes [#2](https://github.com/aigengame/godot-agent/issues/2)
* **gda:** gda info headless tracer bullet ([#2](https://github.com/aigengame/godot-agent/issues/2)) ([d903bdd](https://github.com/aigengame/godot-agent/commit/d903bdd90841657338f0fb5e60d775d4ecbcf6f9))
* **info:** structured JSON errors and distinct exit codes for every failure mode ([66e6527](https://github.com/aigengame/godot-agent/commit/66e6527c12ff6855580181ce4007fd3a3c9e614c))
* **info:** structured JSON errors and distinct exit codes for every failure mode ([#3](https://github.com/aigengame/godot-agent/issues/3)) ([5122dc2](https://github.com/aigengame/godot-agent/commit/5122dc2e5c7a40c43c1dd3af9ea9142f20eb51e6))
* init repo ([6307900](https://github.com/aigengame/godot-agent/commit/63079004c2d7d3a9545c48529b80a9bf569a0557))
...
* **schema:** model-driven --schema self-description on gda info ([bdcc4e2](https://github.com/aigengame/godot-agent/commit/bdcc4e2a2c43c294f05d715149c3807d2e7870af))
* **schema:** model-driven --schema self-description on gda info ([9ee569a](https://github.com/aigengame/godot-agent/commit/9ee569a6744539f371f8ee73ffa46a5314b49664)), closes [#4](https://github.com/aigengame/godot-agent/issues/4)
* **skills:** add reconcile skill for issue/doc consistency ([1e60b88](https://github.com/aigengame/godot-agent/commit/1e60b88568256bd10b935a50312e561ea61c0f5a))
* **skills:** add reconcile skill for issue/doc consistency ([8d7d949](https://github.com/aigengame/godot-agent/commit/8d7d94984719cc5b9f4d85291d0f5b4f8034688d)), closes [#9](https://github.com/aigengame/godot-agent/issues/9)
...
* **gda:** harden failure handling and decouple GDScript args ([78cffd0](https://github.com/aigengame/godot-agent/commit/78cffd017608661f1f5df25e4ebd8ccb40a9c6fb)), closes [#2](https://github.com/aigengame/godot-agent/issues/2)
...
* **info:** treat wrong-shape sentinel payload as a structured parse error ([fce4346](https://github.com/aigengame/godot-agent/commit/fce434656a61f2972b8f1b85f89ce080a9c323a1))
...
* **skills:** make reconcile Stop hook reminder visible ([1604b75](https://github.com/aigengame/godot-agent/commit/1604b758fc5c4f799e287343395cc3722f33023d))


### Documentation

* add MIT license ([7430146](https://github.com/aigengame/godot-agent/commit/743014693d92a4f412a5ae3a8885e1a6186ee2e3)), closes [#2](https://github.com/aigengame/godot-agent/issues/2)
* **adr:** add architecture design ADR-0000 ([43fd78d](https://github.com/aigengame/godot-agent/commit/43fd78d98c0b010c75a028e8089b345e10eaeb29))
* **adr:** polish ADR-0000 to English and fix cross-references ([67373aa](https://github.com/aigengame/godot-agent/commit/67373aab73d0ad720ebce2d78b3fc555883b9ac9))
* **adr:** record CLI command taxonomy ([e2b921b](https://github.com/aigengame/godot-agent/commit/e2b921b388e2614c98551e1d8c78ed7c68d6a36b)), closes [#1](https://github.com/aigengame/godot-agent/issues/1)
* **adr:** record integration mechanism and output contract ([be41985](https://github.com/aigengame/godot-agent/commit/be41985c23b5b177f78a88b0299ba98802ba6078)), closes [#1](https://github.com/aigengame/godot-agent/issues/1)
* **adr:** record target Godot version and --schema semantics ([633690b](https://github.com/aigengame/godot-agent/commit/633690b792d1da0ce675b40fa230b6271efd481d)), closes [#1](https://github.com/aigengame/godot-agent/issues/1)
* **adr:** record the squash-only merge strategy in ADR-0007 ([#75](https://github.com/aigengame/godot-agent/issues/75)) ([2894cfd](https://github.com/aigengame/godot-agent/commit/2894cfdaebc62a2254695d53154911db39804abe))
* **agents:** configure engineering skills for the repo ([ec86bc0](https://github.com/aigengame/godot-agent/commit/ec86bc0c49cf9d17003f0dc2c17000769f485313))
* **agents:** orient coding agents via CONTEXT.md/ADRs, not the whole README ([3a2df28](https://github.com/aigengame/godot-agent/commit/3a2df2888319a6be1af9d2d527977377037fbe44)), closes [#2](https://github.com/aigengame/godot-agent/issues/2)
* broaden README intro to cover all three components ([ade3f00](https://github.com/aigengame/godot-agent/commit/ade3f000760950afa819b40ff5d11e1713cce1f9)), closes [#2](https://github.com/aigengame/godot-agent/issues/2)
...
* **context:** define delivery phases and place gda-mcp ([f89cd77](https://github.com/aigengame/godot-agent/commit/f89cd77482a94f9d807e8e64c75a90e547127e0f)), closes [#1](https://github.com/aigengame/godot-agent/issues/1)
...
* README + command-catalog mark `--schema` done (info, [#4](https://github.com/aigengame/godot-agent/issues/4)). ([9ee569a](https://github.com/aigengame/godot-agent/commit/9ee569a6744539f371f8ee73ffa46a5314b49664))
* **readme:** add project title image ([7b38c6d](https://github.com/aigengame/godot-agent/commit/7b38c6d14c14663c67d9b2fb9f810521d5ed100b))
* **readme:** add project title image ([9c4123d](https://github.com/aigengame/godot-agent/commit/9c4123df30cb6f95c18ec5f6bec760c300fe6101))
...
* rewrite README and unify project description ([577705d](https://github.com/aigengame/godot-agent/commit/577705d64f7f3777b145ba8d02ddaa35cf571ffe)), closes [#2](https://github.com/aigengame/godot-agent/issues/2)
* **roadmap:** incremental command surface + schema-first hard gate ([d4342dc](https://github.com/aigengame/godot-agent/commit/d4342dcf8ba50ab61578a8e37dc3e97a59c42f3d))
* **roadmap:** incremental command surface + schema-first hard gate ([e4ddd33](https://github.com/aigengame/godot-agent/commit/e4ddd33cc01b694659a488cbc5987e42c27f8c50))
* scope AGENTS.md pointer to coding agents in Contributing ([c8b73cb](https://github.com/aigengame/godot-agent/commit/c8b73cbb1ecf1520569d84d773b07561c716bd99)), closes [#2](https://github.com/aigengame/godot-agent/issues/2)
