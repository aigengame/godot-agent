...
| `resource` | `create`, `get`, `set`, `delete`, `uid`, `import` (`.tres` files and project assets; `import` ensures assets — PNGs, scripts, anything the engine imports — are in the project cache: clean-worktree loading) |
