...
def _reason_context(*, remap: bool, event_limit: int | None):
    ...
    if remap:
        ...
        replacements = {
            ...
            "runtime.step_limit_exceeded": "runtime.numeric_overflow",
        }
...
def test_legal_reason_mapping_preserves_exact_terminal_rollback_and_charge(
    ...
    for remap in (False, True):
        context = _reason_context(remap=remap, event_limit=event_limit)
