    ...
    for kind in kinds:
        ...
        if "input" in required:
            ...
            if kind_id == "observation-lifecycle":
                ...
                transition_members = kind.get("transition_members")
                event_members = kind.get("event_members")
                outcome_members = kind.get("outcome_members")
                snapshot_members = kind.get("snapshot_members")
                ...
                if (
                    ...
                    or transition_members != ["event", "snapshot"]
                    or event_members != ["index", "operation", "outcome"]
                    or outcome_members != ["id", "kind"]
                    or snapshot_members != ["index", "name", "values"]
                    or state_members != ["name", "value"]
                ):
                    raise ValueError(
                        "Kernel observation-lifecycle vector contract is incomplete"
                    )
                ...
                outcome_schema: dict[str, object] = {
                    ...
                    "properties": {
                        "id": _non_empty_string_schema(),
                        "kind": {"enum": ["success", "gameplay-alternative"]},
                    },
                    "required": outcome_members,
                    "unevaluatedProperties": False,
                }
                event_schema: dict[str, object] = {
                    ...
                    "properties": {
                        "index": index_schema,
                        "operation": _non_empty_string_schema(),
                        "outcome": outcome_schema,
                    },
                    "required": event_members,
                    "unevaluatedProperties": False,
                }
                state_values_schema: dict[str, object] = {
                    "type": "array",
                    "minItems": 1,
                    "items": _closed_named_value_schema(cast(list[str], state_members)),
                }
                snapshot_schema: dict[str, object] = {
                    ...
                    "properties": {
                        ...
                        "values": state_values_schema,
                    },
                    "required": snapshot_members,
                    "unevaluatedProperties": False,
                }
                properties["input"] = {
                    "type": "object",
                    "properties": {
                        "evaluation_site_identity": _non_empty_string_schema(),
                        "refusal_transition_index": {
                            "oneOf": [{"type": "null"}, index_schema]
                        },
                        "transitions": {
                            "type": "array",
                            "minItems": 1,
                ...
                properties["expect"] = {
                    ...
                    "properties": {
                        ...
                        "post_state": state_values_schema,
                        "snapshot_identities": {
                            "type": "array",
                            "minItems": 1,
