...
| [Priority window](PRIORITY-WINDOW.md) | Early non-RPG protocol, 12 selected extension Type/Operation coordinates, canonical `selected_semantics` + 8 Model artifact content identities, fixed A/B 8 Model + 6 Runtime exchange and superseded inventory-platform history |
